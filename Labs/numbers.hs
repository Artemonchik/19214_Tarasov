...
getIntegerFromLetter char | (ord char) >= ord 'a' && (ord char) <= ord 'z' = toInteger $ ord char - ord 'a' + 10
...
getLetterFromInteger integer | integer >= 0 && integer <= 9 = chr (fromIntegral integer + ord '0')
